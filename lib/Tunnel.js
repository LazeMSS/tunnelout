        ...
        (function getUrl() {
            axios
                ...
                .catch((err) => {
                    ...
                    if (err != undefined && 'response' in err && err.response != undefined && 'data' in err.response && err.response.data != undefined && 'errorMsg' in err.response.data){
                        errogMsg =  err.response.data.errorMsg;
                    }

                    console.error("Failed connecting to %s: %s (%s)",baseUri,errogMsg,err.response.status);
